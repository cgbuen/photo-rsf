  ...
  render() {
    return (
      <Container>
        ...
        <p>Links to other resources that don't fall under any of the other categories on this site. Some attributed to others, but just added here for my own personal reference.</p>
        <ul>
          <li><LinkBlank to="https://forms.gle/tefHXyEh9WsAJjBs9">Film development/scanning signups</LinkBlank>: Signup form/details on pricing for a service I provide to develop and scan your photo film.</li>
