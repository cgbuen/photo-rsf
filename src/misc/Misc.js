    ...
    return (
      <Container>
        ...
        <ul>
          ...
          <li><LinkBlank to={social.sffb}>Donation page to the San Francisco-Marin Food Bank</LinkBlank>: I send all livestream donations (bits / subscriptions) to the SF-Marin Food Bank, but you can also donate here directly.</li>
          <li><LinkBlank to="https://ph-1080.cgbuen.com/mckibbin-son-monograph-series.pdf">The McKibbin & Son Monograph Series</LinkBlank>: a paper I wrote in 2011 for a typographic history class about a lesser-known, eight-volume monograph series on publishing and typography in the late 1940s.</li>
