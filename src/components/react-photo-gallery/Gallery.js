...
const Gallery = React.memo(function Gallery({
  ...
  let galleryStyle, thumbs, galleryStyleClass;
  ...
  return (
    <div className="react-photo-gallery--gallery">
      <div ref={galleryEl} style={galleryStyle} className={galleryStyleClass}>
